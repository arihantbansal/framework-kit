        ...
        const modifyingSigner: TransactionModifyingSigner & TransactionPartialSigner = Object.freeze({
            ...
            async modifyAndSignTransactions(
                ...
                for (const transaction of transactions) {
                    const castTransaction = transaction as Transaction & TransactionWithinSizeLimit & TransactionWithLifetime;
                    const signed = await signTransaction(castTransaction as unknown as SendableTransaction & Transaction);
                ...
                return Object.freeze(signedTransactions) as readonly (
            ...
            async signTransactions(
                ...
                return Object.freeze(
                    signedTransactions.map(signedTransaction =>
                        Object.freeze({ [address]: signedTransaction.signatures[address]! }),
                    ),
